...
class Trainer:
    ...
    def train_epoch(self, train_loader: DataLoader) -> float:
        ...
        for inputs, labels in tqdm(train_loader, desc=f"Epoch {self.current_epoch+1} [Train]"):
    ...
    def validate(self, val_loader: DataLoader) -> tuple:
        ...
        with torch.no_grad():
            for inputs, labels in tqdm(val_loader, desc=f"Epoch {self.current_epoch+1} [Val]"):
                inputs = inputs.to(self.device)
                labels = labels.to(self.device)
            ...
            if val_loader is not None:
                ...
                if val_acc > self.best_val_acc:
                    ...
                    if self.checkpoint_dir:
                        save_path = os.path.join(self.checkpoint_dir, f"best_model_epoch{epoch+1}.pth")
